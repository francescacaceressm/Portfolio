...
DROP DATABASE IF EXISTS "01_portfolio_ecommerce_EN";

CREATE DATABASE "01_portfolio_ecommerce_EN"
	WITH
	OWNER = postgres
	ENCODING = 'UTF8'
...
HAVING ROUND(s.total_amount - SUM(si.item_total), 2) <> 1;

-- =====================================================
-- 5) QUERIES
-- =====================================================

-- 5A) == REVENUE BY SALE CHANNEL ==
...
-- 5D) == REVENUE BY DISCOUNTED VS. NO DISCOUNTED ITEMS ==
